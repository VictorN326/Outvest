...
import {Box, Typography, FormControl, FormHelperText, TextField, TextareaAutosize, Stack, Select, MenuItem, Button, Menu} from '@pankod/refine-mui';
  ...
  return (
    <Box>
      <Typography fontSize={25} fontWeight={700} color='#11142d'>
        {/* type refers to the type of form: create or edit as an ex */}
        {type} a Property
      </Typography>
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        ...
        onSubmit={handleSubmit(onFinishHandler)}>
          ...
          <FormControl>
            ...
            background: 'transparent', fontSize: '16px', borderColor: 'rgba(0,0,0,0.23',borderRadius: 6, padding: 10, color: '#919191'}}
