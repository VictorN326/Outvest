              ...
              <Stack direction="column" gap="30px">
                <Stack gap="15px">
                  ...
                  <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                    ...
                    <Typography fontSize={14} color="#11142D">1234 Beach Blvd. Huntington Beach, California 12345</Typography>
                  </Box>
                </Stack>
                ...
                <Stack direction="row" flexWrap="wrap" gap="20px" pb={4}>
                  <Stack flex={1} gap="15px">
                    ...
                    <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                      ...
                      <Typography fontSize={14} color="#11142D" noWrap>+123 456 7890</Typography>
                    </Box>
                  </Stack>
