...
const Home = () => {
  ...
  return (
      ...
      <Box>
        <Typography fontSize={25} fontWeight={700} color ="#111142D">
          Dashboard
        </Typography>
        ...
        <Box mt="20px" display="flex" flexWrap="wrap" gap={4}>
          <PieChart title="Properties for Sale" value={684} series = {[75,25]} colors = {['#475be8', '#f5b507']}/>
          <PieChart title ="Properties for Rent" value={550} series = {[60,40]} colors={['#475ae8', '#f5b507']}/>
          <PieChart title= "Total Customers" value = {5684} series={[75,25]} colors={['#275be8', '#f5b507']}/>
          <PieChart title ="Properties for Cities" value={555} series={[75,25]} colors={['#275be8','#f5b507']} />
        </Box>
        
        {/* column stack for small and mobile devices and sectioned by rows on bigger devices */}
        <Stack mt="25px" width="100%" direction={{xs: "column", lg: "row"}} gap={4}>
          <TotalRevenue />
          <PropertyReferrals />
        </Stack>
        <Box flex={1} borderRadius="15px" padding="20px" bgcolor="#fcfcfc" display="flex" flexDirection="column" minWidth="100%" marginTop="25px">
